(function() {
    ...
    angular.module('linuxDash').config(['$routeProvider',
        function($routeProvider) {
            ...
            $routeProvider.
            when('/loading', {
                templateUrl: 'static/templates/app/loading.html',
            ...
            when('/system-status', {
                templateUrl: 'static/templates/sections/system-status.html',
            }).
            when('/basic-info', {
                templateUrl: 'static/templates/sections/basic-info.html',
            }).
            when('/network', {
                templateUrl: 'static/templates/sections/network.html',
            }).
            when('/accounts', {
                templateUrl: 'static/templates/sections/accounts.html',
            }).
            when('/apps', {
                templateUrl: 'static/templates/sections/applications.html',
            }).
            otherwise({
                redirectTo: '/loading'
            });
    ...
    angular.module('linuxDash').directive('navBar', function($location) {
        return {
            restrict: 'E',
            templateUrl: 'static/templates/app/navbar.html',
            link: function(scope) {
                scope.items = [
                    'system-status',
                    'basic-info',
    ...
    angular.module('linuxDash').directive('topBar', function() {
        return {
            ...
            templateUrl: 'static/templates/app/ui-elements/top-bar.html',
    ...
    angular.module('linuxDash').directive('lastUpdate', function() {
        return {
            ...
            templateUrl: 'static/templates/app/ui-elements/last-update.html'
        };
    });
    ...
    angular.module('linuxDash').directive('tableData', ['server', '$rootScope', function(server, $rootScope) {
        return {
            ...
            templateUrl: 'static/templates/app/table-data-plugin.html',
    ...
    angular.module('linuxDash').directive('keyValueList', ['server', '$rootScope', function(server, $rootScope) {
        return {
            ...
            templateUrl: 'static/templates/app/key-value-list-plugin.html',
            link: function(scope, element) {
    ...
    angular.module('linuxDash').directive('lineChartPlugin', ['$interval', '$compile', 'server', '$window', function($interval, $compile, server, $window) {
        return {
            ...
            templateUrl: 'static/templates/app/line-chart-plugin.html',
            link: function(scope, element) {
    ...
    angular.module('linuxDash').directive('multiLineChartPlugin', ['$interval', '$compile', 'server', '$window', function($interval, $compile, server, $window) {
        return {
            ...
            templateUrl: 'static/templates/app/multi-line-chart-plugin.html',
            link: function(scope, element) {
    ...
    angular.module('linuxDash').directive('plugin', function() {
        return {
            restrict: 'E',
            transclude: true,
            templateUrl: 'static/templates/app/base-plugin.html'
        }
    });
    ...
    angular.module('linuxDash').directive('progressBarPlugin', function() {
        return {
            ...
            templateUrl: 'static/templates/app/progress-bar-plugin.html'
        };
    });
    ...
    angular.module('linuxDash').directive('themeSwitcher', ['$location', function($location) {
        return {
            restrict: 'E',
            templateUrl: 'static/templates/app/theme-switcher.html',
            link: function(scope) {
